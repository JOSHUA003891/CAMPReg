...
<div class="container">
    <header class="header">
        <h1 class="title">Camp Login Form</h1>
        <p>By <a href="//www.w3jar.com">WEBCLASH</a></p>
    </header>
    <div class="wrapper">
        <div class="form">
            <form method="POST">
                ...
                <button><a href="index.html" type="submit">Go Home</a></button>
            </form>
        </div>
        <div class="user-list">
